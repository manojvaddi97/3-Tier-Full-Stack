...
const dbUrl = (process.env.DB_URL || 'mongodb://127.0.0.1:27017/yelp-camp').trim().replace(/\s+/g, '');
...
const secret = (process.env.SECRET || 'thisshouldbeabettersecret!').replace(/\s+/g, '');
